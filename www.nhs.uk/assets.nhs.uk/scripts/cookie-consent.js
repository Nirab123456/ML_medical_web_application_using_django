! function(t) {
    ...
    var r = e(1),
        ...
        a = function(t, n, e) {
            ...
            for (s in v && (e = n), e) l = ((f = !p && y && void 0 !== y[s]) ? y : e)[s], h = b && f ? c(l, r) : g && "function" == typeof l ? c(Function.call, l) : l, y && u(y, s, l, t & a.U), k[s] != l && i(k, s, h), g && m[s] != l && (m[s] = l)
        };
    ...
    t.exports = function(t, n) {
        ...
        return function(n, c, v) {
            for (var d, g, b = i(n), y = o(b), k = r(c, v, 3), m = u(y.length), x = 0, w = e ? p(n, m) : a ? p(n, 0) : void 0; m > x; x++)
                if ((h || x in y) && (g = k(d = y[x], x, b), t))
                    if (e) w[x] = g;
                    else if (g) switch (t) {
                case 3:
                    return !0;
    ...
    if (e(8)) {
        var r = e(30),
            ...
            Wt = function(t, n) {
                return x(t) && t[kt] && "symbol" != typeof n && n in t && String(+n) == String(n)
            },
            Dt = function(t, n) {
                return Wt(t, n = y(n, !0)) ? l(2, t[n]) : G(t, n)
            },
            Bt = function(t, n, e) {
                return !(Wt(t, n = y(n, !0)) && x(e) && k(e, "value")) || k(e, "get") || k(e, "set") || e.configurable || k(e, "writable") && !e.writable || k(e, "enumerable") && !e.enumerable ? U(t, n, e) : (t[n] = e.value, t)
            };
        ...
        p(Ut, Ct), h(Ut, vt, Ct.values), p(Ut, {
            ...
            k ? (v = e((function(t, e, r, o) {
                f(t, v, s, "_d");
                var i, u, c, a, l = 0,
                    p = 0;
                if (x(e)) {
                    if (!(e instanceof H || "ArrayBuffer" == (a = m(e)) || "SharedArrayBuffer" == a)) return kt in e ? Ft(v, e) : Mt.call(v, e);
                    i = e, p = _t(r, n);
                    var b = e.byteLength;
                    if (void 0 === o) {
                ...
                var i;
                return f(t, v, s), x(e) ? e instanceof H || "ArrayBuffer" == (i = m(e)) || "SharedArrayBuffer" == i ? void 0 !== o ? new b(e, _t(r, n), o) : void 0 !== r ? new b(e, _t(r, n)) : new b(e) : kt in e ? Ft(v, e) : Mt.call(v, e) : new b(g(e))
            })), $(y !== Function.prototype ? O(b).concat(O(y)) : O(b), (function(t) {
                t in v || h(v, t, b[t])
            })), v.prototype = S, r || (S.constructor = v));
            var F = S[vt],
                A = !!F && ("values" == F.name || null == F.name),
                M = Ct.values;
            h(v, gt, !0), h(S, kt, s), h(S, mt, !0), h(S, bt, v), (a ? new v(1)[dt] == s : dt in S) || U(S, dt, {
                get: function() {
                    return s
                }
    ...
    (n = t.exports = function(t, n, e, l, h) {
        ...
        if (i(b)) {
            for (p = c(t.length); p > k; k++)
                if ((g = n ? y(u(v = t[k])[0], v[1]) : y(t[k])) === s || g === f) return g
        } else
            for (d = b.call(t); !(v = d.next()).done;)
    ...
    t.exports = function(t, n, e, d, g, b) {
        ...
        if ("function" == typeof k && (b || x.forEach && !l((function() {
                (new k).entries().next()
            })))) {
            var _ = new k,
                E = _[m](b ? {} : -0, 1) != _,
            ...
            }))).prototype = x, x.constructor = k), (O || F) && (S("delete"), S("has"), g && S("get")), (F || E) && S(m), b && x.clear && delete x.clear
        } else k = d.getConstructor(n, t, g, m), u(k.prototype, e), c.NEED = !0;
        return p(k, t), w[t] = k, o(o.G + o.W + o.F * (k != y), w), b || d.setStrong(k, t, g), k
    }
}, function(t, n, e) {
    ...
    t.exports = function(t, n, e, v, d, g, b) {
        ...
        if (A && (m = f(A.call(new t))) !== Object.prototype && m.next && (s(m, w, !0), r || "function" == typeof m[l] || u(m, l, p)), S && O && "values" !== O.name && (_ = !0, P = function() {
                return O.call(this)
    ...
    h && p || (h = function(t) {
        ...
        d.now(u(y, t, 1))
    } : v ? (i = (o = new v).port2, o.port1.onmessage = k, r = u(i.postMessage, i, 1)) : f.addEventListener && "function" == typeof postMessage && !f.importScripts ? (r = function(t) {
        f.postMessage(t + "", "*")
    }, f.addEventListener("message", k, !1)) : r = "onreadystatechange" in s("script") ? function(t) {
    ...
    function G(t, n, e, r, o, i) {
        ...
        for (var c = t[A]._b, a = u + t[j], s = r(+o), f = 0; f < n; f++) c[a + f] = s[i ? f : n - f - 1]
    }
    if (u.ABV) {
        if (!s((function() {
                y(1)
        ...
        var H = new k(new y(2)),
            J = k.prototype.setInt8;
        H.setInt8(0, 2147483648), H.setInt8(1, 2147483649), !H.getInt8(0) && H.getInt8(1) || a(k.prototype, {
        ...
        f(this, k, "DataView"), f(t, y, "DataView");
        var r = t[M],
            o = l(n);
        if (o < 0 || o > r) throw x("Wrong offset!");
        if (o + (e = void 0 === e ? r - o : h(e)) > r) throw x("Wrong length!");
        this[A] = t, this[j] = o, this[M] = e
    }, o && (B(y, "byteLength", "_l"), B(k, "buffer", "_b"), B(k, "byteLength", "_l"), B(k, "byteOffset", "_o")), a(k.prototype, {
        getInt8: function(t) {
    ...
    b(y, "ArrayBuffer"), b(k, "DataView"), c(k.prototype, u.VIEW, !0), n.ArrayBuffer = y, n.DataView = k
}, function(t, n) {
    var e = t.exports = "undefined" != typeof window && window.Math == Math ? window : "undefined" != typeof self && self.Math == Math ? self : Function("return this")();
    "number" == typeof __g && (__g = e)
}, function(t, n) {
    ...
    t.exports = !s || e(2)((function() {
        ...
        for (var e = c(t), s = arguments.length, f = 1, l = i.f, h = u.f; s > f;)
            for (var p, v = a(arguments[f++]), d = l ? o(v).concat(l(v)) : o(v), g = d.length, b = 0; g > b;) p = d[b++], r && !h.call(v, p) || (e[p] = v[p]);
        return e
    } : s
}, function(t, n) {
    ...
    "use strict";
    e(127);
    var r, o = (r = e(299)) && r.__esModule ? r : {
        default: r
    };
    ...
    var r = e(1),
        ...
        $ = function(t, n, e) {
            return t === G && $(U, n, e), y(t), n = w(n, !0), y(e), o(B, n) ? (e.enumerable ? (o(t, R) && t[R][n] && (t[R][n] = !1), e = _(e, {
                enumerable: S(0, !1)
            })) : (o(t, R) || j(t, R, S(1, {})), t[R][n] = !0), q(t, n, e)) : j(t, n, e)
        },
        K = function(t, n) {
            y(t);
    ...
    V || (c((T = function() {
        ...
        return this._k
    })), O.f = Q, F.f = $, e(34).f = E.f = Z, e(46).f = X, P.f = tt, i && !e(30) && c(G, "propertyIsEnumerable", X, !0), v.f = function(t) {
        return H(p(t))
    }), u(u.G + u.W + u.F * !V, {
        Symbol: T
    });
    ...
    u(u.S + u.F * it, "Object", {
        ...
        stringify: function(t) {
            ...
            if (e = n = r[1], (k(n) || void 0 !== t) && !J(t)) return b(n) || (n = function(t, n) {
    ...
    var r = e(1),
        ...
        y = function(t) {
            ...
            if ("string" == typeof n && n.length > 2) {
                var e, r, o, i = (n = b ? n.trim() : h(n, 3)).charCodeAt(0);
                if (43 === i || 45 === i) {
    ...
    if (!p(" 0o1") || !p("0b1") || p("+0x1")) {
        ...
        for (var k, m = e(8) ? s(v) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","), x = 0; m.length > x; x++) o(v, k = m[x]) && !o(p, k) && l(p, k, f(v, k));
    ...
    o(o.S + o.F * !e(53)((function(t) {
        ...
        from: function(t) {
            var n, e, o, l, h = i(t),
                ...
                b = 0,
                y = f(h);
            if (g && (d = r(d, v > 2 ? arguments[2] : void 0, 2)), null == y || p == Array && c(y))
                for (e = new p(n = a(h.length)); n > b; b++) s(e, b, g ? d(h[b], b) : h[b]);
            else
                for (l = y.call(h), e = new p; !(o = l.next()).done; b++) s(e, b, g ? u(l, d, [o.value, b], !0) : o.value);
            return e.length = b, e
        }
    })
}, function(t, n, e) {
    ...
    e(56)("replace", 2, (function(t, n, e, v) {
        return [function(r, o) {
            ...
            for (var y = [];;) {
                ...
                if (null === k) break;
                if (y.push(k), !g) break;
                "" === String(k[0]) && (l.lastIndex = c(h, i(l.lastIndex), b))
            }
            for (var m, x = "", w = 0, S = 0; S < y.length; S++) {
                k = y[S];
                for (var _ = String(k[0]), E = s(f(u(k.index), h.length), 0), O = [], P = 1; P < k.length; P++) O.push(void 0 === (m = k[P]) ? m : String(m));
                var F = k.groups;
                if (p) {
    ...
    e(56)("split", 2, (function(t, n, e, f) {
        ...
        return d = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1)[p] || 2 != "ab".split(/(?:ab)*/)[p] || 4 != ".".split(/(.?)(.?)/)[p] || ".".split(/()()/)[p] > 1 || "".split(/.?/)[p] ? function(t, n) {
            ...
            for (var m = 0, x = 0, w = []; x < h.length;) {
                y.lastIndex = v ? x : 0;
                var S, _ = a(y, v ? h : h.slice(x));
                if (null === _ || (S = l(c(y.lastIndex + (v ? 0 : x)), h.length)) === m) x = u(h, x, g);
                else {
                    if (w.push(h.slice(m, x)), w.length === k) return w;
                    for (var E = 1; E <= _.length - 1; E++)
                        if (w.push(_[E]), w.length === k) return w;
                    x = m = S
                }
            }
            return w.push(h.slice(m)), w
        }]
    }))
}, function(t, n, e) {
    var r = e(1),
    ...
    var r, o = e(1),
        ...
        k = t.exports = e(59)("WeakMap", b, y, s, !0, !0);
    ...
    for (var r = e(81), o = e(31), i = e(11), u = e(1), c = e(14), a = e(40), s = e(5), f = s("iterator"), l = s("toStringTag"), h = a.Array, p = {
        ...
        var g, b = v[d],
            ...
            k = u[b],
            m = k && k.prototype;
        if (m && (m[f] || c(m, f, h), m[l] || c(m, l, b), a[b] = h, y))
        ...
        function k(t, n) {
            ...
            if (void 0 === e) {
                if (n.delegate = null, "throw" === n.method) {
                    if (t.iterator.return && (n.method = "return", n.arg = void 0, k(t, n), "throw" === n.method)) return s;
    ...
    var r = e(86),
        ...
        a = function(t, n, e) {
            ...
            for (s in p && (e = n), e)(f = !h && m && void 0 !== m[s]) && c(y, s) || (l = f ? m[s] : e[s], y[s] = p && "function" != typeof m[s] ? e[s] : g && f ? i(l, r) : b && m[s] == l ? function(t) {
            ...
            }(l) : d && "function" == typeof l ? i(Function.call, l) : l, d && ((y.virtual || (y.virtual = {}))[s] = l, t & a.R && k && !k[s] && u(k, s, l)))
        };
    ...
    function w() {
        var t, n = (t = "nhsuk-cookie-consent", u()[t] || null);
        return JSON.parse(n)
    }
    ...
    function E(t) {
        var n, e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : k,
            r = "/";
        if (e === k) n = 90;
        else {
            if (e !== m && e) throw new Error("Cookie mode ".concat(e, " not recognised"));
            n = null
        }
        var o = _(),
            i = b(b(b({}, o), t), {}, {
    ...
    function O() {
        var t, n = null === (t = w()) ? null : t.version;
        return null === n ? null : n >= 4
    }
    ...
    function I(t) {
        ...
        n.open("GET", "https://www.nhs.uk/our-policies/cookies-policy/?policy-action=".concat(t)), n.send()
    }
    var T = e(124).a;
    ...
    window.NHSCookieConsent = {
        ...
        var t, n, e, r;
        Object(d.getNoBanner)() || document.location.href === Object(d.makeUrlAbsolute)(Object(d.getPolicyUrl)()) || null !== w() && O() && !1 !== P("consented") || (t = M, n = j, e = I, (r = document.createElement("div")).innerHTML = s.a, r.innerHTML += "<style>".concat(l.a.toString(), "</style>"), document.body.insertBefore(r, document.body.firstChild), e("seen"), document.getElementById("nhsuk-cookie-banner__link_accept").addEventListener("click", (function(n) {
